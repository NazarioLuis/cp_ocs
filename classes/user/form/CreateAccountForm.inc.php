...
class CreateAccountForm extends Form {
	...
	function CreateAccountForm() {
		...
		if ($this->existingUser) {
			...
			$this->addCheck(new FormValidator($this, 'phone', 'required', 'user.profile.form.affiliationRequired'));
			$this->addCheck(new FormValidator($this, 'affiliation', 'required', 'user.profile.form.phoneRequired'));
